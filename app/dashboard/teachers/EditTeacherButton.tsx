...
export default function EditTeacherButton({
  ...
  async function edit() {
    ...
    const specialization = prompt(t("editPromptSpecialization"), currentSpecialization ?? "");
    if (specialization === null) return;

    const qualifications = prompt(t("editPromptQualifications"), currentQualifications ?? "");
